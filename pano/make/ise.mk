...
BIN_FILE = $(PROJECT_DIR)/${PROJECT}.bin
VPATH = $(SRC_DIR)
...
all: $(PROJECT_DIR) $(NGC_FILES) $(BIT_FILE) $(PLATFORM_BITFILE) $(BIN_FILE)
...
$(PROJECT_DIR)/$(PROJECT)_routed.ncd: $(PROJECT_DIR)/$(PROJECT).ncd
	...
	@echo "####################################################################"
	cd $(PROJECT_DIR); $(TOOL_PATH)/par $(PAR_CMDS) -xe c $(PROJECT).ncd $(PROJECT)_routed.ncd $(PROJECT).pcf
